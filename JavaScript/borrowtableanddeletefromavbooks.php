...
if(isset($_POST['insert']))
{
    ...
    $query = "INSERT INTO `tra` VALUES ('$s1','$s2','$s3','$s4','$s5')";
...
?>
 ...
 <html>  
      <head>  
           <title>Create Transaction</title>     <meta charset="utf-8">
  ...
  background-color: rgb(214, 226, 236);
      ...
      <body>  
        <section>
           ...
           <br /><br />   
                <b><h1 align="center">Add Transaction</h3></b>
                <br />  
<div class="container">                
<form action="borrowtableanddeletefromavbooks.php" method="post">
